...
MODALITY_CONFIG_PATH="$BASE_DIR/rldx/configs/data/so101_config.py" # see rldx/configs/data/ for examples
...
ARGS=(
    ...
    --dataset-path "$BASE_DIR/examples/pick-wood-2"
    ...
    # --- Single-GPU (40GB) memory-saving settings ---
    # per_device batch = global-batch-size / num-gpus; keep tiny on 1 GPU.
    --global-batch-size 8
    --gradient-accumulation-steps 16
    --gradient-checkpointing
    --no-backbone-trainable-params-fp32
